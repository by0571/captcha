...
\think\Route::get('captcha/[:id]', "\\by0571\\captcha\\CaptchaController@index");
...
{
    $captcha = new \by0571\captcha\Captcha($config);
...
{
    $captcha = new \by0571\captcha\Captcha((array)\think\Config::get('captcha'));
